...
const NAV = [
  {
    ...
    icon: <RiDashboardLine size={17} />,
    label: "Dashboard",
  },
  { href: "/admin/prompts", icon: <RiImageLine size={17} />, label: "Prompts" },
  {
    href: "/admin/upload",
    icon: <RiImageAddLine size={17} />,
    label: "Add Prompt",
  },
  {
    href: "/admin/payments",
    icon: <RiVipCrownLine size={17} />,
    label: "Payments",
  },
...
function SidebarContent({ onClose }: { onClose?: () => void }) {
  ...
  async function handleLogout() {
    await logout();
    setUser(null); // optimistic clear — don't wait for onAuthStateChanged
    ...
    <div className="flex flex-col h-full">
            ...
            <Link
              ...
              style={
                isActive
                  ? {
                      background:
                        "linear-gradient(135deg, rgba(188,103,255,0.18), rgba(188,103,255,0.08))",
      ...
      >
        ...
        <button
          ...
          onMouseEnter={(e) =>
            (e.currentTarget.style.background = "rgba(240,80,80,0.08)")
          }
          onMouseLeave={(e) =>
...
export function AdminSidebar() {
  ...
  return (
    <>
      ...
      {mobileOpen && (
        <div
          className="fixed inset-0 z-[290] bg-black/50 backdrop-blur-sm md:hidden"
